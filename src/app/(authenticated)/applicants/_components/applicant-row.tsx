    ...
    >
      ...
      <TableCell className="px-5 py-4 pl-5">
        <div className="flex items-center gap-3">
          ...
          <span className="max-w-36 truncate text-sm font-bold text-dashboard-dark whitespace-normal wrap-break-word text-center">
      ...
      {/* Rol */}
      <TableCell className="px-3 py-4 text-sm font-medium text-dashboard-text-muted whitespace-normal wrap-break-word text-center">
      ...
      <TableCell className="px-3 py-4">
        <Badge
          ...
          variant="secondary"
          className={`rounded-md border-transparent px-2 py-1 text-xs font-bold whitespace-normal wrap-break-word text-center`}
        >
      ...
      <TableCell className="px-3 py-4 pr-5">
        ...
        >
          <span className="max-w-36 truncate text-sm whitespace-normal wrap-break-words text-center">
